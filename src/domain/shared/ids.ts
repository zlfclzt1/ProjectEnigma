...
export type ProfessionFacilityId = BrandedId<"ProfessionFacilityId">;
export type ConsumableEffectId = BrandedId<"ConsumableEffectId">;
export type ServiceId = BrandedId<"ServiceId">;
export type SupplyPlanId = BrandedId<"SupplyPlanId">;
