...
- [x] 16 件 Boss 专属装备逐件完成 Classic XML 核对。
- [x] 计划录入的任务奖励逐件完成 Classic XML 核对。
- [x] 随机稀有 Boss 的三件装备不出现在其他 Boss 池。
- [x] 工程材料、图纸、钥匙、任务物品与世界掉落已排除。
- [x] 所有来源为 `classic-2019-phase-6`，不含探索赛季内容。
