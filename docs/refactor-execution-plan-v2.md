...
> 2026-09-08 更新：本文档的阶段 0–6 保留为 V2 架构建设记录。原阶段 7 中“新增黑暗深渊后立即开发专业与坐骑”的顺序已被新的产品路线取代，不应继续按原顺序执行。当前实施入口改为：[10–45 级祖尔法拉克阶段实施计划](./zulfarrak-stage-implementation-plan.md)。专业、仓库与坐骑仍是有效的长期架构方向，但推迟到 45–60 级内容和熔火之心团队副本原型之后再排期。
