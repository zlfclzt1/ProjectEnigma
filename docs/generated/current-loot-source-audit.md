...
- 路线 Encounter：144。
- 掉落表：124。
- 掉落表分类：Boss 专属掉落 124，任务奖励 0，世界掉落 0，设计占位 0。
- Encounter 引用分类：Boss 专属掉落 124，任务奖励 0，世界掉落 0，设计占位 0，无装备掉落 20。
- 不同装备分类：Boss 专属掉落 404，任务奖励 0，世界掉落 0，设计占位 0。
- 成员副本任务：52，不同任务奖励装备：127。
- Boss 掉落与任务奖励重复：0。
...
### 黑石深渊：暗炉城（blackrock_depths_shadowforge_city）

| Encounter | 掉落表 | 分类 | 保证数量 | 装备 |
|---|---|---|---:|---|
| 安格弗将军（brd_shadowforge_general_angerforge） | brd_shadowforge_general_angerforge | Boss 专属掉落 | 1 | 11820 盛饰护甲、11821 战争护腿、11810 意志之力、11817 安格弗的剑、11816 安格弗的战斧、11841 主设计师的长裤 |
| 傀儡统帅阿格曼奇（brd_shadowforge_golem_lord_argelmach） | brd_shadowforge_golem_lord_argelmach | Boss 专属掉落 | 1 | 11823 渊博褶裙、11822 全法长靴、11669 阿格曼奇之戒、11819 复苏之风 |
| 霍尔雷·黑须（brd_shadowforge_hurley_blackbreath） | brd_shadowforge_hurley_blackbreath | Boss 专属掉落 | 1 | 11735 怒气眼罩、18043 煤工长靴、22275 火苔长靴、18044 霍尔雷的酒杯 |
| 雷布里·斯库比格特（brd_shadowforge_ribbly_screwspigot） | — | 无装备掉落 | 0 | — |
| 普拉格（brd_shadowforge_plugger_spazzring） | brd_shadowforge_plugger_spazzring | Boss 专属掉落 | 1 | 12793 普拉格的外套、12791 酒吧凶器 |
| 法拉克斯（brd_shadowforge_phalanx） | brd_shadowforge_phalanx | Boss 专属掉落 | 1 | 22212 石傀儡肩铠、11745 法拉克斯之拳、11744 血拳、11743 石拳 |
| 弗莱拉斯大使（brd_shadowforge_ambassador_flamelash） | brd_shadowforge_ambassador_flamelash | Boss 专属掉落 | 1 | 11808 烈焰之环、11812 火灵斗篷、11814 熔岩之拳、11832 博学坠饰、11809 烈焰之怒 |
| 无敌的潘佐尔（brd_shadowforge_panzor） | brd_shadowforge_panzor | Boss 专属掉落 | 1 | 22245 煤烟护足、11787 岩壳长靴、11785 石傀儡之盾、11786 大地之石 |
| 七贤（brd_shadowforge_seven） | brd_shadowforge_seven | Boss 专属掉落 | 1 | 11925 幽灵面罩、11926 死灵胸甲、11929 鬼灵护腿、11927 永恒守护者腿铠、11920 鬼魂镰刀、11923 恩赐之锤、11922 血蚀之刃、11921 磐石巨锤 |
| 讲学厅（brd_shadowforge_lyceum） | — | 无装备掉落 | 0 | — |
| 玛格姆斯（brd_shadowforge_magmus） | brd_shadowforge_magmus | Boss 专属掉落 | 1 | 11746 石颅头盔、11935 玛格姆斯之石、22395 怒气图腾、22400 真言圣契、22208 熔岩石锤 |
| 茉艾拉·铜须公主（brd_shadowforge_princess_moira） | brd_shadowforge_princess_moira | Boss 专属掉落 | 1 | 12557 乌钢肩甲、12554 传令官之手、12556 高阶女祭司之靴、12553 迅捷长靴 |
| 达格兰·索瑞森大帝（brd_shadowforge_emperor_dagran_thaurissan） | brd_shadowforge_emperor_dagran_thaurissan | Boss 专属掉落 | 1 | 11684 反对者、11933 帝王宝石、11930 皇帝的新斗篷、11924 皇冠法袍、22204 名望护腕、22207 追猎腰带、11934 皇帝徽记、11815 正义之手、11928 索瑞森皇家节杖、11931 恐怖复仇者、11932 智慧手杖 |

### 死亡矿井（deadmines）

| Encounter | 掉落表 | 分类 | 保证数量 | 装备 |
|---|---|---|---:|---|
| 拉克佐（dm_rhahkzor） | dm_rhahkzor | Boss 专属掉落 | 1 | 872 切石者、5187 拉克佐之锤 |
| 斯尼德的伐木机（dm_sneeds_shredder） | dm_sneeds_shredder | Boss 专属掉落 | 1 | 1937 电锯、2169 蜂鸣之刃 |
| 斯尼德（dm_sneed） | dm_sneed | Boss 专属掉落 | 1 | 5194 工头战斧、5195 金斑手套 |
| 基尔尼格（dm_gilnid） | dm_gilnid | Boss 专属掉落 | 1 | 1156 豪华珠宝戒指、5199 铁匠短裤 |
| 重拳先生（dm_mr_smite） | dm_mr_smite | Boss 专属掉落 | 1 | 7230 重拳先生的大锤、5192 潜行者之刃、5196 重拳先生的战斧 |
...
| Encounter | 掉落表 | 分类 | 保证数量 | 装备 |
|---|---|---|---:|---|
| 雷希戈尔（sfk_rethilgore） | sfk_rethilgore | Boss 专属掉落 | 1 | 5254 皱褶肩甲 |
| 屠夫拉佐克劳（sfk_razorclaw） | sfk_razorclaw | Boss 专属掉落 | 1 | 1292 屠夫的切肉刀、6226 鲜血围裙、6633 屠夫的剔骨刀 |
| 席瓦莱恩男爵（sfk_baron_silverlaine） | sfk_baron_silverlaine | Boss 专属掉落 | 1 | 6321 席瓦莱恩家族徽记、6323 巴隆的节杖 |
| 指挥官斯普林瓦尔（sfk_commander_springvale） | sfk_commander_springvale | Boss 专属掉落 | 1 | 6320 指挥官纹章盾、3191 曲刃战斧 |
| 盲眼守卫奥杜（sfk_odo） | sfk_odo | Boss 专属掉落 | 1 | 6318 奥杜之杖、6319 盲者束带 |
| 吞噬者芬鲁斯（sfk_fenrus） | sfk_fenrus | Boss 专属掉落 | 1 | 6340 芬鲁斯的外皮、3230 黑狼护腕 |
...
| Encounter | 掉落表 | 分类 | 保证数量 | 装备 |
|---|---|---|---:|---|
| 安娜科德拉（wc_lady_anacondra） | wc_lady_anacondra | Boss 专属掉落 | 1 | 10412 尖牙腰带、5404 坚硬的肩垫 |
| 考布莱恩领主（wc_lord_cobrahn） | wc_lord_cobrahn | Boss 专属掉落 | 1 | 6460 考布莱恩的腰带、10410 尖牙护腿、6465 水蛇法袍 |
| 克雷什（wc_kresh） | wc_kresh | Boss 专属掉落 | 1 | 6447 破旧的龟壳盾牌、13245 克雷什之背 |
| 皮萨斯领主（wc_lord_pythas） | wc_lord_pythas | Boss 专属掉落 | 1 | 6472 毒蛇之刺、6473 尖牙铠甲 |
| 斯卡姆（wc_skum） | wc_skum | Boss 专属掉落 | 1 | 6449 发光的蜥蜴披风、6448 尾钉 |
| 瑟芬迪斯领主（wc_lord_serpentis） | wc_lord_serpentis | Boss 专属掉落 | 1 | 6469 毒蛇、5970 毒蛇手套、10411 尖牙足垫、6459 野蛮锁靴 |
...
| 黑石深渊：暗炉城（blackrock_depths_shadowforge_city） | 雷布里·斯库比格特（brd_shadowforge_ribbly） | 11865 怨恨之靴、11963 忏悔肩铠、12049 钢条护甲 |
| 黑石深渊：暗炉城（blackrock_depths_shadowforge_city） | 爱情药水（brd_shadowforge_love_potion） | 11962 镣铐护腕、11866 娜玛拉的腰带 |
| 黑石深渊：暗炉城（blackrock_depths_shadowforge_city） | 失落的雷酒秘方（brd_shadowforge_hurley） | 11964 迅捷木槌、12000 叉刃巨斧 |
| 黑石深渊：暗炉城（blackrock_depths_shadowforge_city） | 行动：杀死安格弗将军（brd_shadowforge_angerforge） | 12059 征服者勋章 |
| 黑石深渊：暗炉城（blackrock_depths_shadowforge_city） | 机器的崛起（brd_shadowforge_rise_of_machines） | 12109 蓝月披肩、12110 雨法师斗篷、12108 黑陶鳞片护甲、12111 熔岩护手 |
| 黑石深渊：暗炉城（blackrock_depths_shadowforge_city） | 拯救公主（brd_shadowforge_royal_rescue） | 12548 麦格尼的意志、12543 铁炉堡歌唱石、12544 萨尔的决心、12545 奥格瑞玛之眼 |
